...
$error = "";
    if(isset($_POST['submitroom']))
    {
        ...
        $query =  "INSERT INTO roomss (building_id, roomno, spaces, price, img) values ('$building_id','$rooms','$spaces','$price','$image')";
        ...
        $error .='<p class="alert alert-success">Room Added succesfully</p>';
        
        }
        else {       

         $error .='<p class="alert alert-danger">Room Addition failed. Try Again</p>';
